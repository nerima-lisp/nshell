...
(asdf:defsystem "nshell"
  ...
  ((:file "package")
   ...
   (:file "domain/execution/job")
     ...
     (:file "domain/parsing/ast-control-flow")
   ...
   (:file "domain/parsing/tokenizer-dispatch-routes")
   ...
   (:file "domain/parsing/parser-redirect-facts")
   ...
   (:file "application/shell-context")
	   ...
	   (:file "application/execute-pipeline-expansion-data")
               (:file "application/command-substitution")
   ...
   (:file "application/builtin-agent")
   (:file "application/builtin-ai")
   (:file "application/builtin-theme")
   (:file "application/builtin-prompt")
   (:file "application/builtin-bind")
   (:file "application/builtin-math")
   (:file "application/builtin-directory-stack")
   (:file "application/builtin-functions")
...
(:file "application/builtin-printf")
   ...
   (:file "presentation/input-state-ask")
   ...
   (:file "presentation/repl-theme")
   (:file "presentation/repl-highlight")
   (:file "presentation/repl-search-ui")
   ...
   (:file "presentation/repl-execution-command")
	   ...
	   (:file "presentation/repl-output-transient-panel")
	   (:file "presentation/repl-export")
   ...
   (:file "presentation/repl-agent")
   (:file "presentation/repl-ai")
   ...
   (:file "presentation/repl-output")
	   ...
	   (:file "presentation/repl-assistant-progress")
...
(asdf:defsystem "nshell/test"
  ...
  ((:file "package")
   ...
   (:file "unit/test-assistant-context")
   (:file "unit/test-assistant-audit")
   (:file "unit/test-assistant-model-boundary")
   (:file "unit/test-ai-builtin")
   ...
   (:file "unit/test-builtin-bind")
   (:file "unit/test-builtin-shell-extras")
   (:file "unit/test-completion-dynamic")
   (:file "unit/test-repl-search-ui")
   (:file "unit/test-highlight")
   ...
   (:file "unit/test-input-state-ask")
