...
(defun process-output-event (output-event)
  (case output-event
    ...
    (:ask-start (%process-ask-start-output-event))
    (:ask-submit (%process-ask-submit-output-event))
    (:ask-cancel (%process-ask-cancel-output-event))
    (:ask-cancel-turn (%process-ask-cancel-turn-output-event))
