...
(describe "input-state-tests"
  (it "pbt-input-state-word-navigation-respects-shell-token-boundaries"
  ...
  (it "pbt-input-state-word-navigation-respects-shell-operator-boundaries"
  ...
  (it "input-state-buffer-never-exceeds-reasonable-size"
    (let* ((limit 4096)
  ...
  (it "pbt-input-state-end-at-eol-accepts-entire-suggestion"
  ...
  (it "pbt-input-state-ctrl-e-matches-end-for-suggestion-acceptance"
  ...
  (it "pbt-input-state-cursor-navigation-clears-autosuggestion"
  ...
  (it "pbt-input-state-right-and-ctrl-f-share-insert-mode-navigation"
