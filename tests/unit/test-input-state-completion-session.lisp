...
(test input-completion-session-clear-rejects-history-search-clear
  (signals error
    (nshell.presentation::apply-completion-session-clear
     (input-state)
     (nshell.presentation::history-search-session-clear))))
