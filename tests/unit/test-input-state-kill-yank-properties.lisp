...
(describe "input-state-tests"
  (it "pbt-input-state-ctrl-u-then-yank-restores-buffer"
  ...
  (it "pbt-input-state-ctrl-k-then-yank-restores-buffer"
  ...
  (it "pbt-input-state-alt-backspace-then-yank-restores-buffer"
  ...
  (it "pbt-input-state-alt-d-then-yank-restores-buffer"
  ...
  (it "pbt-input-state-alt-d-kills-one-escaped-space-token"
  ...
  (it "pbt-input-state-alt-d-then-yank-restores-operator-token"
  ...
  (it "pbt-input-state-alt-y-replaces-last-yank-with-next-kill"
