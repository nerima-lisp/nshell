...
(describe "input-state-tests"
  (it "pbt-input-state-end-and-ctrl-e-only-accept-suggestion-at-eol"
  ...
  (it "pbt-input-state-alt-right-accepts-compact-redirection"
  ...
  (it "pbt-input-state-alt-s-twice-restores-buffer"
  ...
  (it "pbt-input-state-ctrl-t-preserves-length-and-characters"
  ...
  (it "pbt-input-state-alt-t-preserves-length-and-characters"
  ...
  (it "pbt-input-state-alt-case-preserves-length-and-cursor-bounds"
  ...
  (it "pbt-input-state-undo-redo-roundtrips-typed-line"
  ...
  (it "pbt-terminal-control-h-matches-backspace-edit"
  ...
  (it "pbt-terminal-ctrl-d-delete-or-quit-contract"
